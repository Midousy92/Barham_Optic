...
if (loginForm) {
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            btnSubmit.insertAdjacentHTML('beforebegin', `<p class="firebase-msg" style="color: #007bff; margin-bottom: 10px; font-weight: bold; text-align: center;">✅ Connexion réussie ! Redirection...</p>`);
...
async function handleGoogleLogin(e, formElement) {
    ...
    try {
        ...
        btnSubmit.insertAdjacentHTML('beforebegin', `<p class="firebase-msg" style="color: #007bff; margin-bottom: 10px; font-weight: bold; text-align: center;">✅ Connexion Google réussie ! Redirection...</p>`);
